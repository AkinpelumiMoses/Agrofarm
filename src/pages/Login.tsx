...
// const Login = () => {
//   return (
//     <div className="min-h-screen flex bg-white-600">
...
//       {/* Right Side - Transparent Form over Green Background */}
//       <div className="w-full lg:w-1/2 flex items-center justify-center px-6 sm:px-8 py-12">
//         <div className="rounded-xl p-8 w-full max-w-md space-y-6 bg-white bg-opacity-90 shadow-lg">
//           {/* Logo */}
...
//             <Link
//               to="/signup"
//               className="text-white hover:text-gray-100 font-medium underline"
//             >
//               Sign Up
//             </Link>
//           </p>
